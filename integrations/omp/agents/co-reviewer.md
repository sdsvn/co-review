...
- Explain what the code does and why in words. Don't walk through file paths and line numbers; if a pointer helps, end with one or two links like path/to/file.ext:42.
